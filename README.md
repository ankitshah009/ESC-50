...
| <sub>**Knowledge Transfer from Weakly Labeled Audio using Convolutional Neural Network for Sound Events and Scenes**</sub> | <sub>CNN pretrained on AudioSet</sub> | <sub>83.50%</sub> | <sub>[kumar2017](https://arxiv.org/pdf/1711.01369.pdf)</sub> |  |
...
| <sub>**Look, Listen and Learn**</sub> | <sub>8-layer convolutional subnetwork pretrained on an audio-visual correspondence task</sub> | <sub>79.30%</sub> | <sub>[arandjelovic2017](https://arxiv.org/pdf/1705.08168.pdf)</sub> |  |
...
| <sub>**An Approach for Self-Training Audio Event Detectors Using Web Data**</sub> | <sub>44.1kHz sampling rate,MFCC-BoAW - Multi Layer Perceptron with tuned hyperparameters</sub> | <sub>67.50%</sub> | <sub>[belizalde,ashah,sdalmia,mhlee,rbadlani,kumar2017](http://ieeexplore.ieee.org/document/8081532/)</sub> | :scroll:</a> |
